	...
	english: {
		...
		modules: {
			...
			prototypes: {
				...
				speech1: `Designing is a progressive process, 
	...
	french: {
		...
		homepage: {
			...
			expertise: {
				...
				text: `Fort d'une expérience de travail avec les maisons de 
			...
			prototypes: {
				title: "Prototypes & rendus",

				text: `Tôt pendant le développement,
			...
			casting: {
				title: "Pièces de fonte",
				text: `Une fois votre bijou conçu,
			...
			doc: {
				title: "Documentation",
				text: `Je peux fournir la documentation
			...
			contact: {
				...
				webdevLink: 'Développement web',
				samplesLink: 'Échantillons',
				contactLink: 'Contact'
			}
		...
		modules: {
			...
			expertise: {
				...
				presentation: {
					...
					speech1: `J'ai travaillé pendant plus de deux ans chez
					...
					speech2: `Armé de ces compétences en design et en gestion,
				...
				service: {
					...
					speech: `Vous pouvez m'engager pour gérer vos projets 
			...
			prototypes: {
				...
				speech1: `Le design est un processus évolutif,
				...
				speech2: `Pour obtenir ce design parfait et nous 
				...
				speech3: `Si vous ne possédez pas d'imprimante 3D pour
			...
			casting: {
				...
				speech1: `Votre projet est conçu et dessiné. Vous pouvez
				...
				speech2: `Si vous ne possédez pas votre propre imprimante 3D
			...
			doc: {
				...
				speech1: `Une fois votre projet conçu, vous n'êtes pas
				...
				speech2: `J'adapte la documentation à chaque projet,
			...
			webdev: {
				...
				speech1: `Le développement web a été ma passion 
				...
				speech2: `Ce site que vous visitez fut entièrement designé et
			...
			contact: {
				...
				speech: `Je serai ravi de répondre à toute demande
